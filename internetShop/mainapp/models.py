...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if img.height > max_height or img.width > max_width:
            raise MaxResolutionErrorException('Разрешение изображение выше максимального!')
...
class Smartphone(Product):
    ...
    sd_volume_max = models.CharField(
        max_length=255, null=True, blank=True, verbose_name='Максимальный обьем встраиваимой памяти'
    )
    main_cam_mp = models.CharField(max_length=255, verbose_name='Основная камерпа')
